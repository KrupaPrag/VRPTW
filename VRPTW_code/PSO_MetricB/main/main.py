...
for  i in range(len(dataset_list)):
    ...
    PSO_benchmark_val = round(PSO_benchmark_NV + np.arctan(PSO_benchmark_dist)/(math.pi/2),2)
    ...
    best_benchmark_val = round(best_benchmark_NV + np.arctan(best_benchmark_dist)/(math.pi), 2)
...
# =============================================================================
    ...
    for experiment in range(num_experiments):
        ...
        gbest_NV = arr_gbest_result[0]
        gbest_dist = round(arr_gbest_result[2],2)
...
#            
            ...
            gbest_fitness = round(arr_gbest_result[2],2)
            gbest_NV = arr_gbest_result[0]
            gbest_dist = round(arr_gbest_result[1],2)
