...
def full_recombination(alpha, beta, num_cores, K_val,r, N,arr_pop_results, arr_new_pop_results, arr_customers, arr_distance_matrix, total_time, total_capacity, pop_chromosome_routeList_array, pop_chromosome_distanceList_array, new_pop_chromosome_routeList_array, new_pop_chromosome_distanceList_array, service_time):
#    num_cores = 2
...
#    chromosome1_routes, chromosome2_routes, chromosome1_distances, chromosome2_distances, chromosome1_total_distance, chromosome2_total_distance
    ...
    arr_new_pop_results[:,2] = alpha*(arr_new_pop_results[:,0]) + beta*(arr_new_pop_results[:,1])
...
#%%
def mutation(alpha, beta, N,num_cores, arr_pop_results, pop_chromosome_routeList_array, pop_chromosome_distanceList_array,arr_distance_matrix, arr_customers, total_time, total_capacity, service_time ):
...
#        print('mutation')
        ...
        for i in updated_indicies:
            ...
            arr_pop_results[i, 2] = alpha*(len(pop_chromosome_distanceList_array[i])) + beta*(sum(pop_chromosome_distanceList_array[i]))
