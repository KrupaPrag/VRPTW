...
#       READ OUT FILES
        ...
        #phase2
#        pop_chromosome_routeList_array, pop_chromosome_distanceList_array, pop_num_routes, pop_total_distance = initial_population_phase2(N, num_cores, arr_customers, arr_distance_matrix, total_capacity, total_time, pop_chromosome_routeList_array, pop_chromosome_distanceList_array, pop_num_routes, pop_total_distance, alpha, beta)
        ...
        #METRIC: GA PAPER alpha*numV + beta*distance
        df_initial_results.loc[:,'fitness'] = (alpha*pop_num_routes)+(beta*pop_total_distance)
